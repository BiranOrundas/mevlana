...
<head>	
	...
	<!-- Canonical URL -->
	<link rel="canonical" href="https://www.mevlanabazaar.com" />
							...
							<div class="container-fluid">
								...
								<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
									<ul class="nav navbar-nav navbar-right" id="top-nav">
										...
										<li><a href="#price">Menü</a></li>
										<li><a href="#subscribe">Haberler</a></li>
					...
					<div class="block">
						...
						<form>
							...
							<div class="form-group wow fadeInDown" data-wow-duration="500ms" data-wow-delay="1000ms">
								<textarea class="form-control" rows="3" placeholder="Bize göndermek istediiniz teşekkür, öneri, şkayet mesajınız"></textarea>
							</div>
						</form>
